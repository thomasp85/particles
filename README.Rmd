...
knitr::opts_knit$set(animation.fun = function(x, options, format = "gif") {
  ...
  mov <- image_read(figs)
  mov <- image_animate(mov, fps = 25)
  image_write(mov, paste0(knitr::opts_knit$get("base.url"), mov.fname))
  unlink(figs)
  sprintf("![%s](%s)", options$label, paste0(knitr::opts_knit$get("base.url"), mov.fname))
})
```
